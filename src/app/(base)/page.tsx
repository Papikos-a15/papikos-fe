...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-100 via-white to-green-50 text-gray-800">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center max-w-7xl mx-auto gap-12">
          <div className="w-full md:w-1/2 flex flex-col justify-center text-left md:pl-10">
            <h1 className="text-4xl md:text-5xl font-bold text-black mb-6 leading-tight">
              Sewa Kos Aman & Mudah <br /> bersama{" "}
              <span className="text-green-700">Papikos</span>
            </h1>
            <p className="text-sm text-gray-500 mb-4">
              {isLoggedIn
                ? `Selamat datang kembali! Peran Anda: ${localStorage.getItem("role") || "Tidak diketahui"}`
                : "Belum punya akun? Daftar sekarang untuk pengalaman terbaik."}
            </p>
            <p className="text-lg text-gray-700 mb-8 max-w-md">
              Platform terpercaya yang mempertemukan penyewa dan pemilik kos
              dalam satu aplikasi yang praktis dan efisien.
            </p>
      ...
      <section
        id="about"
        className="max-w-6xl mx-auto bg-green-100 rounded-2xl p-10 shadow-inner mt-20 mb-20"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white rounded-xl shadow p-6 border border-green-200 hover:shadow-lg transition">
            ...
            <p className="text-sm text-gray-600">
              Login & registrasi dengan validasi admin agar setiap akun
              terpercaya.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow p-6 border border-green-200 hover:shadow-lg transition">
            <div className="text-4xl mb-4">🏠</div>
            <h3 className="text-xl font-semibold text-green-800 mb-2">
              Manajemen Kos Praktis
            </h3>
            <p className="text-sm text-gray-600">
              Pemilik kos bisa kelola data kos dan penyewaan dalam satu
              dashboard.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow p-6 border border-green-200 hover:shadow-lg transition">
            ...
            <p className="text-sm text-gray-600">
              Bayar dan top up saldo langsung dari aplikasi secara aman & cepat.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white shadow-md p-6 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-gray-600">
              Login dan registrasi aman untuk penyewa, pemilik, dan admin dengan
              persetujuan admin.
            </p>
          </div>
          <div className="bg-white shadow-md p-6 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-gray-600">
              Penyewa dapat mencari, melihat detail, dan menyewa kos dengan
              mudah.
            </p>
          </div>
          <div className="bg-white shadow-md p-6 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-gray-600">
              Pemilik kos dapat menambah, edit, dan hapus data kos serta
              mengelola penyewaan.
            </p>
          </div>
          <div className="bg-white shadow-md p-6 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-gray-600">
              Top up saldo dan bayar sewa kos langsung dari aplikasi dengan
              sistem transparan.
            </p>
          </div>
          <div className="bg-white shadow-md p-6 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-gray-600">
              Penyewa dan pemilik kos dapat berkomunikasi langsung lewat chat
              aplikasi.
            </p>
          </div>
          <div className="bg-white shadow-md p-6 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-gray-600">
              Pantau kos favorit Anda dan dapatkan notifikasi saat kamar
              tersedia.
            </p>
          </div>
        </div>
