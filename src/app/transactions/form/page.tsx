...
export default function CreatePaymentPage() {
    ...
    const handleTopUpSubmit = async () => {
        ...
        try {
            ...
            setTopUpMessage("❌ Error: " + err.message);
        }
    };
    ...
    return (
        <main className="max-w-2xl mx-auto p-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                <h2 className="text-xl font-semibold mb-4 text-green-600">Top-up Saldo</h2>
                ...
                {topUpMessage && (
                    <div className={`mt-4 p-3 rounded-md ${topUpMessage.includes('✅')
